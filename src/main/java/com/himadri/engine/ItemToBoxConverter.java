...
public class ItemToBoxConverter {
    ...
    public Box createBox(List<Item> items, int indexOfProductGroup) {
    ...
    private String getBoxTitle(List<Item> items) {
        ...
        for (int i = 1; i < items.size(); i++) {
            ...
            if (!StringUtils.equals(boxTitle, itemTitle)) {
                userSession.getErrorCollector().addErrorItem(ErrorCollector.Severity.WARN,
