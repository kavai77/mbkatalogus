...
public class CatalogueReaderWithSuperCsv implements CatalogueReader {
    private static final Logger LOGGER = LoggerFactory.getLogger(CatalogueReaderWithSuperCsv.class);
